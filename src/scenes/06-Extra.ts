...
export default class ExtraScene extends Scene {
    ...
    public load(): void {
        this.game.loader.load({
            ...
            ["batman.obj"]:{url:'models/batman.obj', type:'text'}
        });
    } 
    ...
    public start(): void {
        ...
        this.batman = MeshUtils.LoadOBJMesh(this.gl, this.game.loader.resources["batman.obj"]);

        this.camera = new Camera();
        this.camera.type = 'perspective';
        this.camera.position = vec3.fromValues(50, 50, -100);
    ...
    public draw(deltaTime: number): void {
        ...
        let Matbatman = mat4.create();
        mat4.translate(Matbatman, Matbatman, [0, 10, 0]);
        mat4.scale(Matbatman, Matbatman, [10,10,10]);
        this.fogProgram.setUniformMatrix4fv("M", false, Matbatman);
        this.fogProgram.setUniform4f("tint", [1.0, 0.4, 0.5, 1.0]);
        this.batman.draw(this.gl.TRIANGLES);
